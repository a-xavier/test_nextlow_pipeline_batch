...
workflow single_fastq_subworkflow {
    ...
    main:
        ...
        // FASTA Reference    # invoke index
        def alignment_reference_mmi_file_ch = channel.fromPath("${params.reference_dir}/Reference_Genomes/Human/GRCh38/Homo_sapiens.GRCh38.dna_sm.toplevel.mmi")
        def alignment_reference_fasta_ch = channel.fromPath("${params.reference_dir}/Reference_Genomes/Human/GRCh38/Homo_sapiens.GRCh38.dna_sm.toplevel.fa")
        def alignment_reference_fasta_index_ch = channel.fromPath("${params.reference_dir}/Reference_Genomes/Human/GRCh38/Homo_sapiens.GRCh38.dna_sm.toplevel.fa.fai")
        def alignment_reference_fasta_dict_ch = channel.fromPath("${params.reference_dir}/Reference_Genomes/Human/GRCh38/Homo_sapiens.GRCh38.dna_sm.toplevel.dict")
        // Common variant vcf
        def common_variant_vcf_ch = channel.fromPath("${params.reference_dir}/dbSNP/Human/GRCH38/00-common_all.vcf.gz")
        def common_variant_vcf_index_ch = channel.fromPath("${params.reference_dir}/dbSNP/Human/GRCH38/00-common_all.vcf.gz.tbi")
        ...
        aligned_bam_ch = SINGLE_FASTQ_ALIGNMENT(fastq_and_preset_ch, alignment_reference_mmi_file_ch)
